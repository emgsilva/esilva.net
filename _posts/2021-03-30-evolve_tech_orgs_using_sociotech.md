...
After motivating the need for systems thinking, I share my current mental model to describe the system ("whole") on tech-driven organizations. I see it as a Sociotechnical System [<a href="#sociotech-arch-silva">Sociotech-Arch-Silva</a>], where you have a customer/market, raising demands to the organization/teams, who then build/evolve the product that the customer will use. Figure below shows a representation of the parts and their core interactions.
After motivating the need for systems thinking, I share my current mental model to describe the system ("whole") on tech-driven organizations. I see it as a Sociotechnical System [<a href="#sociotech-arch-silva">Sociotech-Arch-Silva</a>], where you have a customer/market, raising demands to the organization/teams, who then build/evolve the product that the customer will use. Figure below shows a representation of the parts and their core interactions.
