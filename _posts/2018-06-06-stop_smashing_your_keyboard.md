...
```TL;DR: post about my presentation on bol.com spaces summit 2018. I talk about the need to
stop just smashing our keyboards and "blindly" focus on "speed", and start thinking about what
 we are doing, why and how. By zooming out and thinking we basically consider architecture
 and design we will, which results in adding "direction" to our "speed" and with that achieve
 "higher velocity".
```
