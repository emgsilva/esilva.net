...
> **Note**: Throughout this article, we will use Team Topologies [[TT](#tt)] visualizations to depict the organization across its phases over the years. To get a quick overview of the basic Team Topologies elements, check this page: <https://teamtopologies.com/key-concepts>
...
The combination of rapid growth and market demand and an increasingly unsuitable architecture of systems and teams (the "Sociotechnical Architecture") was leading to a "Burning Platform" [[Burning_Platform](#burning-platform)] situation. The organization and its systems were unfit to cope with the exponential growth around them.
...
- [TT] [Team Topologies](https://teamtopologies.com), Matthew Skelton and Manuel Pais.<a name="tt"></a>
- [Enabling_Continuous_Modernization] [https://esilva.net/modernization](https://esilva.net/modernization), Eduardo da Silva.<a name="enabling-continuous-modernizatoin"></a>
- [BBoM] [Big Ball of Mud (BBoM)](https://www.laputan.org/mud/), Brian Foote and Joseph Yoder.<a name="bbom"></a>
- [Burning_Platform] [Burning Platform](https://resiliencealliance.com/change-management-classics-burning-platform/), Daryl Conner.<a name="burning-platform"></a>
- [ISH] [Independent Service Heuristics (ISH)](https://teamtopologies.com/key-concepts-content/finding-good-stream-boundaries-with-independent-service-heuristics), Team Topilogies.<a name="ish"></a>
- [AMET] [Architecture Modernization Enabling Team (AMET)](https://esilva.net/amet), Eduardo da Silva and Nick Tune.<a name="amet"></a>
- [Kickstarter_Workshop][Kickstarter Workshop](https://esilva.net/talks/#kandddinsky_2024), Eduardo da Silva and Nick Tune.<a name="kickstarter-workshop"></a>
- [Wardley_Maps] [Wardley Maps](https://www.swardleymaps.com/), Simon Wardley.<a name="wardley-maps"></a>
- [Core_Domain_Maps] [Core Domain Maps](https://github.com/ddd-crew/core-domain-charts), Nick Tune and DDD-crew.<a name="core-domain-maps"></a>
- [ProdTech] [ProdTech Teams](https://esilva.net/articles/prodtech), Eduardo da Silva.<a name="prodtech"></a>
- [Theory_of_Constraints] [Theory of Constraints (ToC)](https://www.leanproduction.com/theory-of-constraints/), Dr. Eliyahu Goldratt.<a name="toc"></a>
- [Enabling_Leader] [Becoming Enabling Leader Training](https://esilva.net/products/becoming-enabling-leader), Eduardo da Silva.<a name="enabling-leader"></a>

## Changelog

- 16/09/2026: first version of the article published
